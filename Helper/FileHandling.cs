...
namespace WasIchHoerePlaylist.Helper
{
    internal class FileHandling
    {
        ...
        /// <param name="pFilePath"></param>
        /// <returns></returns>
        public static async Task<string> AsyncReadContentOfFile(string pFilePath)
        {
            ...
            try
            {
                ...
                {
                    rtrn = await File.ReadAllTextAsync(pFilePath);
                }
            }
            catch (Exception ex)
            {
        ...
        public static async Task<int> AsyncWriteStringToFileOverwrite(string pFilePath, string pContent)
        {
            try
            {
                if (doesFileExist(pFilePath))
                ...
                await File.WriteAllTextAsync(pFilePath, pContent);
                return 0;
            }
            catch (Exception ex)
            {
        ...
        public static void WriteStringToFileOverwrite(string pFilePath, string pContent)
        {
            try
            {
                ...
                File.WriteAllText(pFilePath, pContent);
            }
            catch (Exception ex)
            {
                Logger.Log(ex);
        ...
        public static void AddToLog(string pFilePath, string pLineContent)
        {
            ...
            {
                // this would infinite loop, since this calls Logger.Log with string, and that calls this
                Logger.Log(ex, 3, true, false);
            }
        }
